...
import { deleteSubCategory } from "@/queries/subCategory";
...
export default function CellActions({ rowData }: CellActionsProps) {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              router.push(`/dashboard/admin/subcategories/${rowData.id}`);
            }}
          >
            <Edit size={15} />
            Edit Details
